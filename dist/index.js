        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        answerLength = this.getAnswerLength();
                        return [4 /*yield*/, promptInput("\u300C,\u300D\u533A\u5207\u308A\u3067".concat(answerLength, "\u3064\u306E\u6570\u5B57\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002"))];
                    case 1:
    ...
    HitAndBlow.prototype.getAnswerLength = function () {
        switch (this.mode) {
            ...
            case 'hard':
                return 4;
            default:
                throw new Error("".concat(this.mode, "\u306F\u7121\u52B9\u306A\u30E2\u30FC\u30C9\u3067\u3059\u3002"));
        }
    };
...
var Janken = /** @class */ (function () {
    ...
    Janken.prototype.play = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, promptSelect("\u3010".concat(this.currentRound, "\u56DE\u6226\u3011\u9078\u629E\u80A2\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002"), jankenOptions)];
                    case 1:
